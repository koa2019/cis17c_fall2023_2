...
void Bank::start(){
    ...
    cout<<endl<<endl;
    cout<<"Total clerks #1:   "<<nClerks<<endl;
    cout<<"Total clerks:   "<<nClerks<<endl;
    cout<<"Number of customers: "<<crrntCust<<endl;
    cout<<"Total Time:          "<<time/60<<" minutes"<<endl;
    cout<<"Total Wait Time:     "<<ttlWaitTime<<" seconds"<<endl;
    cout<<"Average Wait Time:   "<<ttlWaitTime/crrntCust<<" seconds"<<endl;
}
