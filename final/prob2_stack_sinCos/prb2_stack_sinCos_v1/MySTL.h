...
protected: 
    ...
    int countSin1; //sin f() 1st return statement counter
    int countSin2; //sin f() 2nd return statement counter
    int countCos1; //cos g() 1st return statement counter
    int countCos2; //cos g() 2nd return statement counter
