/* File:    main.cpp
 * Author:  Danielle F
 * Created: 12-10-2023 @ 4:21 PM
 * Purpose:  cis-17c final problem 2 Stack sin & cos v2
 * 
 * v2:
 * 
 * To do:
 * create separate loop to call and print cosh()
 * push each value in their own container:
        * ysin,
        * hcount,
        * gcount,
        * ycos, 
