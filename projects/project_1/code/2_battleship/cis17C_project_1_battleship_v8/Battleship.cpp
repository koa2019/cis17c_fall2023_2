...
Battleship::Battleship(){
    cout<<"Hit Battleship Constructor\n"; 
    maxGmes = 5;
    ttlGmes = 0;
    ttlRnds = 0;   
    ...
    cout<<"End Battleship Constructor\n"; 
    start();
}
...
//bool Battleship::start(Player &user){//passing guest user or logged user
bool Battleship::start(){        
    
    player[indx[0]]->askName();  
    //********************************************
    ...
    while (nGmsLft>0) {
        ...
        catch(Battleship::NegativeGames){cout<<"Error. Negative games.\n";}         
...
//****************************************************************
bool Battleship::play(int a,int b){
...
//////    Constructor #3
//////***********************************************************
////Battleship::Battleship(int maxGam){
////    setName("Guest 3");
////    maxGmes = maxGam;
////    ttlGmes = 0;
////    ttlRnds = 0;
...
////   Copy constructor
////***********************************************************
//Battleship::Battleship(const Battleship &obj) {
//    maxGmes = obj.maxGmes;
//    ttlGmes = obj.ttlGmes;
//    ttlRnds = obj.ttlRnds;
//}
...
//***********************************************************
void Battleship::setTtlGmes(int num){    
...
//******************************************************************************
void Battleship::getBanner(string title) {
...
//******************************************************************************
void Battleship::hitMiss(int &pGuess, char &i, bool isHit) {
    if (isHit) {
        cout << setw(12) << i << " == S\n";
