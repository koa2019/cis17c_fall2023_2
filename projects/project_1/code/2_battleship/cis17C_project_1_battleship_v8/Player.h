...
protected:
    ...
    int fnSize;
    unordered_set<string> fNames{"mom", "bart", "homer", "jillian", "ting", "victor", "cora"};
...
public:    
    ...
    void start();// MySTL
    void askName();  //  MySTL. get player 1's name using pass by reference
    string getMin();// MySTL. returns min name    
    
    void setName();//sets name with a random min from fNames
    void setName(string);
