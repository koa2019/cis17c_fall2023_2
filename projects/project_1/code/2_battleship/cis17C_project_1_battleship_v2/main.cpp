 ...
 * 
 * Version 2:
 * Is based off my CIS 5 project 2 version 6 code.
 * Ran the original code to make sure the game worked. Then I commented everything out and added convertArrayToSTL_v2b. It works.
 * Copied the working functions from convertArrays_To_STL_v2 & v3 here.
 * set2Upper() uses mutating algorithm
 * setTopPlyr() copies a set into am already partial filled list
 * setTopPlyr() combines a set and list to create a map pair("name",hiScore)
 */
