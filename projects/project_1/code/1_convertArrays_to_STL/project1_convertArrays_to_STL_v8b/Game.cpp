...
void Game::prntDeq(deque<string> &deq){
...
// Print deque Reverse
//https://www.techiedelight.com/iterate-deque-forward-backward-cpp/
void Game::prntDeqRev(deque<string> &deq){
...
void Game::prntQue(queue<string> &que){
    queue<string> temp1;
    while(!que.empty()){
...
// Fills container with sequential numbers [0,size]
 ...
 void Game::shuffleThis(deque<int> &deq){
