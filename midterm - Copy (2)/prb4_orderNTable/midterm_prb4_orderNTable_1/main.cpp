 ...
 * Author: Danielle
 * Created: 11-01-23
 * Purpose: for midterm prb 4. 
 * Used Order N table N values and Used Midterm prb 9 
 */
...
int main(int argc, char** argv){
    ...
    double n = 2, y=0;
    double stop = 3.6e6;//6.4e4;//2.6e9;
    //long double stop = 3.2e10;//3.2e12;
    ...
    cout<<"n = "<<n<<endl;
    cout<<"y = "<<y<<endl;
    cout<<"             cmath ln("<<n<<") = "<<n*log(n)<<endl;

    //cout<<"Power ln Recursive ln("<<n<<") = "<<n*logFactRec(n)<<endl;
