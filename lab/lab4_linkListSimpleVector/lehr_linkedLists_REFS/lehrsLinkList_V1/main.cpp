/*
    ...
    Date:   November 29th, 2021  1:12pm
    Purpose:Linked from first principles v1a
 * 
 * Lehr's unedited version
 */
...
int main(int argc, char** argv) {
    ...
    lnk1->lnkNext=lnk2;
    lnk1->lnkNext->lnkNext=lnk3; //alt way can be lnk2->lnkNext=lnk3
