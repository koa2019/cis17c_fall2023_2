 ...
 * Program uses a structure and traverses tree 4 different ways.
 * 
 * To do:
 * Reference AVLTreeTest_Delete.cpp or AVL_binaryTree_3
 * Add AVL class
 * Stick newNode into an insert()
 *  */
...
// Acts as an insert new node function
