 ...
 * 12-4-23
 * v3:
 * loop through names array nLoops to 
 * compare Prob of false positives with the calculated in excel.
 * 
 * v2:
...
int main(int argc, char** argv) {
	...
	for (int i = 0; i < 33; i++) { 
        ...
        cout<<endl<<"50-50 mix of strings inside bitarray\n";
        ...
        int sumProbPresent=0;
        int nLoops=1000;
        //cout<<endl<<"Searching for a random string\n";
        ...
        cout<<endl;
        cout<<" Bit array size: 100\n";
        cout<<" 33 strings inserted and hashed into bit array.\n";
        cout<<" 4 hash functions used.\n";
        cout<<" Names array size: 8\n";
        cout<<" nLoop: " << nLoops << endl;
        cout<<" Sum of string Probably already present: "<< sumProbPresent  << endl;
	return 0; 
}
