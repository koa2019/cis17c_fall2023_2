 ...
 * 
 * Using Lehr's midterm > SimpleVectorUsingLinkedList/LinkedList.h
   as template and reference.
...
class LinkedList {
    ...
    public:
        ...
        void pshFrnt(const int); //Push a link to the head
        void pshBack(int); //Push a link to the end. Lehr's addLst()
        void fndPshFrnt(const int); //Find and then Push a link to the end
        int popFrnt();      //Pull/pop a link from the head
        int popBack();      //Pull/pop a link from the back
...
/******************************************************************************/
template<class T>
int LinkedList<T>::popBack(){ // Link<int> *oldList    
int last = 0;    
...
/******************************************************************************/
template<class T>
void LinkedList<T>::pshBack(int newTailData){ 
...
/******************************************************************************/
template<class T>
void LinkedList<T>::pshFrnt(const int data){     
    //temp=head; //Declare pointers used to step through the list
    Link *add=new Link;        //Create the new link
...
/******************************************************************************/
//template<class T>
//Link<int> LinkedList<T>::*popBack(Link<int> *oldList){ 
//    
